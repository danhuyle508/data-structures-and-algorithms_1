...
const citiesAtoJ = (arr) => {
    let array= [];
    let check = /\b[A-J]\w*\b/gi;
    arr.forEach((element) =>{
        if(check.test(element) === true){
            array.push(element);
        }    
    })
    return array;
